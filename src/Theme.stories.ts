...
export const Colors: Story = {
  render: () => ({
    setup() {
      ...
      const primaryColors = [
        { labelKey: 'translate.showcase.theme.colors.primary', token: '--color-primary', hex: '#400EC9', rgb: 'rgb(64, 14, 201)', swatch: '#400EC9' },
        { labelKey: 'translate.showcase.theme.colors.secondary', token: '--color-secondary', hex: '#349CE7', rgb: 'rgb(52, 156, 231)', swatch: '#349CE7' },
        { labelKey: 'translate.showcase.theme.colors.tertiary', token: '--color-tertiary', hex: '#00ECCB', rgb: 'rgb(0, 236, 203)', swatch: '#00ECCB' },
      ]

      const statusColors = [
        { labelKey: 'translate.showcase.theme.colors.success', token: '--color-success', hex: '#00ECCB', rgb: 'rgb(0, 236, 203)', swatch: '#00ECCB' },
        { labelKey: 'translate.showcase.theme.colors.error', token: '--color-error', hex: '#FC5A5A', rgb: 'rgb(252, 90, 90)', swatch: '#FC5A5A' },
        { labelKey: 'translate.showcase.theme.colors.warning', token: '--color-warning', hex: '#fca25a', rgb: 'rgb(255, 165, 0)', swatch: '#fca25a' },
        { labelKey: 'translate.showcase.theme.colors.info', token: '--color-info', hex: '#349CE7', rgb: 'rgb(52, 156, 231)', swatch: '#349CE7' },
      ]

      const neutralColors = [
        { labelKey: 'translate.showcase.theme.colors.dark', token: '--color-dark', hex: '#222121', rgb: 'rgb(34, 33, 33)', swatch: '#222121', border: false },
        { labelKey: 'translate.showcase.theme.colors.text', token: '--color-text', hex: '#3D647C', rgb: 'rgb(61, 100, 124)', swatch: '#3D647C', border: false },
        { labelKey: 'translate.showcase.theme.colors.grey', token: '--color-grey', hex: '#92929D', rgb: 'rgb(146, 146, 157)', swatch: '#92929D', border: false },
        { labelKey: 'translate.showcase.theme.colors.light_grey', token: '--color-light-grey', hex: '#e3e1e1', rgb: 'rgb(227, 225, 225)', swatch: '#e3e1e1', border: true },
        { labelKey: 'translate.showcase.theme.colors.white', token: '--color-white', hex: '#FFF', rgb: 'rgb(255, 255, 255)', swatch: '#FFF', border: true },
        { labelKey: 'translate.showcase.theme.colors.app_background', token: '--color-app-background', hex: '#F2F5F7', rgb: 'rgb(242, 245, 247)', swatch: '#F2F5F7', border: true },
      ]
      ...
      const bodyText = [
        {
          ...
          style: 'font-size: 16px; line-height: 1.6; color: #3D647C; margin: 0 0 16px 0;',
        },
        {
          key: 'translate.showcase.theme.typography.body_small',
          style: 'font-size: 14px; line-height: 1.6; color: #3D647C; margin: 0 0 16px 0;',
        },
        {
          key: 'translate.showcase.theme.typography.body_supporting',
          style: 'font-size: 12px; line-height: 1.6; color: #92929D; margin: 0;',
        },
      ]
