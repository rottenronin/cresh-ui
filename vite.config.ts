  ...
  plugins: [
    ...
    dts({
      ...
      exclude: [
        ...
        "src/**/*.spec.ts",
        "src/**/*.cy.ts",
        "src/helpers/vue-test-helper.ts",
      ],
      // rollupTypes: true,
    ...
    lib: {
      ...
      entry: {
        ...
        "form-controls": path.resolve(
          __dirname,
          "src/components/form-controls/index.ts",
        ),
      ...
      fileName: (format: string, entryName: string) =>
        `${entryName === "." ? "cresh-ui" : entryName}.${format}.js`,
      formats: ["es", "cjs"],
    },
    rollupOptions: {
      ...
      plugins: [
        ...
        copy({
          targets: [
            ...
            {
              src: "./src/styles/preprocessor/fonts.scss",
              dest: "./dist/sass",
            },
            {
              src: "./src/styles/preprocessor/break-points.scss",
              dest: "./dist/sass",
            },
            {
              src: "./src/styles/preprocessor/computeds.scss",
              dest: "./dist/sass",
            },
            {
              src: "./src/styles/preprocessor/utils.scss",
              dest: "./dist/sass",
            },
